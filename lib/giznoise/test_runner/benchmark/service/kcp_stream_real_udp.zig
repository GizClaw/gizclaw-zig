...
fn runOneWay(comptime grt: type, allocator: grt.std.mem.Allocator) !void {
    ...
    bench.print(grt, "giznoise.service.kcp_stream.real_udp.one_way_transfer", config, elapsed_ns, .{
        .tier = .regular,
    ...
    printObserved(grt, "giznoise.service.kcp_stream.real_udp.one_way_transfer", state);
}
...
fn runBidirectional(comptime grt: type, allocator: grt.std.mem.Allocator) !void {
    ...
    grt.std.mem.doNotOptimizeAway(state.checksum);
    bench.print(grt, "giznoise.service.kcp_stream.real_udp.bidirectional_transfer", config, elapsed_ns, .{
        .tier = .regular,
        .payload_bytes_per_op = state.received_bytes,
        .copy_bytes_per_op = state.sent_bytes,
        .extra_name = "udp_datagrams",
    ...
    printObserved(grt, "giznoise.service.kcp_stream.real_udp.bidirectional_transfer", state);
}
