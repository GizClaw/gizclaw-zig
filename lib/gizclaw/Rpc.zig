...
pub const method_server_model_create = models.RpcMethods.server_model_create;
pub const method_server_model_put = models.RpcMethods.server_model_put;
pub const method_server_model_delete = models.RpcMethods.server_model_delete;
...
pub const method_server_credential_create = models.RpcMethods.server_credential_create;
pub const method_server_credential_put = models.RpcMethods.server_credential_put;
pub const method_server_credential_delete = models.RpcMethods.server_credential_delete;
...
pub const method_server_friend_invite_token_get = models.RpcMethods.server_friend_invite_token_get;
pub const method_server_friend_invite_token_create = models.RpcMethods.server_friend_invite_token_create;
pub const method_server_friend_invite_token_clear = models.RpcMethods.server_friend_invite_token_clear;
pub const method_server_friend_add = models.RpcMethods.server_friend_add;
...
pub const method_server_friend_group_invite_token_get = models.RpcMethods.server_friend_group_invite_token_get;
pub const method_server_friend_group_invite_token_create = models.RpcMethods.server_friend_group_invite_token_create;
pub const method_server_friend_group_invite_token_clear = models.RpcMethods.server_friend_group_invite_token_clear;
pub const method_server_friend_group_join = models.RpcMethods.server_friend_group_join;
