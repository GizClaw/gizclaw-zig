...
pub const SpecType = blk: {
    ...
    builder.addSpecSlices(&.{
        ...
        @embedFile("spec/user_stories/led_status_colors_follow_connectivity.json"),
...
pub fn make(comptime platform_ctx: type, comptime platform_grt: type) type {
    return launcher.make(struct {
        ...
        pub const title = "gizclaw-zux-smoke";
        pub const description = "Button, WiFi, GizClaw, and LED strip Zux smoke user story.";
        const Renders = renders_mod.make(platform_grt, ZuxApp);
        ...
        pub fn init(allocator: glib.std.mem.Allocator, base_config: ZuxApp.InitConfig) !*Self {
            ...
            init_config.led_state_render = ZuxApp.RenderHook.init(&self.renders.led);
        ...
        pub fn createTestRunner() glib.testing.TestRunner {
            return smokeTestRunner(platform_grt);
        }
    });
}

pub fn smokeTestRunner(comptime platform_grt: type) glib.testing.TestRunner {
    ...
    const UserStoryConfigFactoryImpl = struct {
        ...
        pub fn make(self_factory: *@This(), init_config: ZuxApp.InitConfig) !*Instance {
            ...
            self_factory.instance.init_config.led_state_render = ZuxApp.RenderHook.init(&self_factory.instance.renders.led);
...
pub fn run(comptime platform_ctx: type, comptime platform_grt: type) !void {
    ...
    t.run("gizclaw-zux-smoke/stories", Launcher.createTestRunner());
