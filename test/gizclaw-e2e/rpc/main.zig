...
fn checkWorkspacePages(comptime sdk: type, client: *sdk.Client, summary: *common.Summary, options: RpcOptions) !void {
    ...
    if (options.allow_mutations) {
        try summary.skip("CreateWorkspace", "mutation fixture creation is reserved for workspace e2e");
        try summary.skip("PutWorkspace", "mutation fixture update is reserved for workspace e2e");
    } else {
        try summary.skip("CreateWorkspace", "mutating method; covered by workspace e2e");
        try summary.skip("PutWorkspace", "mutating method; covered by workspace e2e");
    }
}
...
fn checkWorkflowPages(comptime sdk: type, client: *sdk.Client, summary: *common.Summary, options: RpcOptions) !void {
    ...
    if (options.allow_mutations) {
        try summary.skip("CreateWorkflow", "mutation fixture creation is reserved for workspace e2e");
        try summary.skip("PutWorkflow", "mutation fixture update is reserved for workspace e2e");
    } else {
        try summary.skip("CreateWorkflow", "mutating method; covered by workspace e2e");
        try summary.skip("PutWorkflow", "mutating method; covered by workspace e2e");
    }
}
...
fn checkSocialPages(comptime sdk: type, client: *sdk.Client, peer_client: ?*sdk.Client, peer_id: ?[]const u8, summary: *common.Summary, options: RpcOptions) !void {
    if (options.allow_mutations) {
        try checkContactMutations(sdk, client, summary);
    } else {
        try checkContactPages(sdk, client, summary);
        try summary.skip("CreateContact", "mutating method; rerun with --allow-mutations for isolated fixture coverage");
        try summary.skip("PutContact", "mutating method; rerun with --allow-mutations for isolated fixture coverage");
        try summary.skip("DeleteContact", "mutating method; rerun with --allow-mutations for isolated fixture coverage");
    }

    try checkFriendRequestPages(sdk, client, summary);
    try checkFriendPages(sdk, client, summary);
    var friend_id: ?[]u8 = null;
    defer if (friend_id) |value| std.heap.page_allocator.free(value);
    if (options.allow_mutations and peer_client != null and peer_id != null) {
        friend_id = try checkFriendRequestMutations(sdk, client, peer_client.?, peer_id.?, summary);
    } else {
        try summary.skip("CreateFriendRequest", "mutating method; requires --allow-mutations and --peer-context");
        try summary.skip("AcceptFriendRequest", "mutating method; requires --allow-mutations and --peer-context");
        try summary.skip("RejectFriendRequest", "mutating method; requires --allow-mutations and --peer-context");
    }

    if (options.allow_mutations) {
        try checkFriendGroupMutations(sdk, client, peer_id, summary);
    } else {
        try checkFriendGroupPages(sdk, client, summary, options);
        try summary.skip("CreateFriendGroup", "mutating method; rerun with --allow-mutations for isolated fixture coverage");
        try summary.skip("PutFriendGroup", "mutating method; rerun with --allow-mutations for isolated fixture coverage");
        try summary.skip("DeleteFriendGroup", "mutating method; rerun with --allow-mutations for isolated fixture coverage");
        try summary.skip("AddFriendGroupMember", "mutating method; requires isolated group and peer fixture");
        try summary.skip("PutFriendGroupMember", "mutating method; requires isolated group member fixture");
        try summary.skip("DeleteFriendGroupMember", "mutating method; requires isolated group member fixture");
    }

    if (!options.allow_mutations and options.friend_group_id != null and options.audio_base64 != null) {
        var message = client.sendFriendGroupMessage(.{
            .friend_group_id = options.friend_group_id.?,
            .audio_base64 = options.audio_base64.?,
            .audio_content_type = "audio/opus",
        }) catch |err| return summary.fail("SendFriendGroupMessage", err);
        defer message.deinit();
        try validateFriendGroupMessage(summary, "SendFriendGroupMessage", message.value);
    } else if (!options.allow_mutations) {
        try summary.skip("SendFriendGroupMessage", "requires --friend-group-id and --audio-base64 Opus fixture");
    }

    if (friend_id) |id| {
        try parsed(summary, "DeleteFriend", client.deleteFriend(.{ .id = id }));
    } else {
        try summary.skip("DeleteFriend", "mutating method; requires accepted friend fixture from --peer-context");
    }
}
